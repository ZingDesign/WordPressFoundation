	...
	<nav class="navigation post-navigation" role="navigation">
		...
		<div class="nav-links">
			...
			if ( is_attachment() ) :
				...
				previous_post_link( '%link', __( '<span class="meta-nav">Previous Post</span>%title', 'zingdesign' ) );
				next_post_link( '%link', __( '<span class="meta-nav">Next Post</span>%title', 'zingdesign' ) );
			endif;
			?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
...
function zd_posted_on() {
	...
	printf( ' <span class="byline"><span class="author vcard"><i class="fa fa-user"></i><a class="url fn n" href="%4$s" rel="author">%5$s</a></span></span> <span class="entry-date"><i class="fa fa-clock-o"></i><a href="%1$s" rel="bookmark"><time class="entry-date" datetime="%2$s">%3$s</time></a></span>',
