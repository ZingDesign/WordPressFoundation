...
if( ! function_exists( 'get_font_awesome_icons' ) ) :
...
if( !function_exists('get_font_awesome_option_list') ) :
	function get_font_awesome_option_list($value=null) {
		$html = $selected = '';

		foreach(get_font_awesome_icons() as $icon_name => $css_char) {
			$selected = ($value === $icon_name) ? ' selected' : '';

			$html .= "<option value=\"$icon_name\" class=\"fa fa-{$icon_name}\"{$selected}>{$icon_name}</option>\n";
		}
		return $html;
	}
endif;
